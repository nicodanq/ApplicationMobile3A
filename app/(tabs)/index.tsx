...
export default function EtudeDetailScreen({ navigation }: EtudeDetailScreenProps) {
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.contentContainer}>
          ...
          <Animated.View entering={FadeInDown.delay(100).springify()} style={styles.categoryBadge}>
            <Text style={styles.categoryText}>Changement Climatique</Text>
          </Animated.View>
          ...
          <Animated.View entering={FadeInDown.delay(400).springify()} style={styles.section}>
            ...
            <Text style={styles.description}>
              ...
              changement climatique sur la biodiversité. Les chercheurs ont analysé des données collectées sur plusieurs
              décennies dans différentes régions du monde.
            </Text>
            <Text style={styles.description}>
          ...
          <Animated.View entering={FadeInDown.delay(500).springify()} style={styles.section}>
            ...
            <View style={styles.objectiveItem}>
              ...
              <Text style={styles.objectiveText}>Analyser les données climatiques des 50 dernières années</Text>
            </View>

            <View style={styles.objectiveItem}>
              <View style={styles.objectiveDot} />
              <Text style={styles.objectiveText}>Cartographier les changements dans la distribution des espèces</Text>
            </View>
            ...
            <View style={styles.objectiveItem}>
              <View style={styles.objectiveDot} />
              <Text style={styles.objectiveText}>Proposer des stratégies d&apos;adaptation et de conservation</Text>
            </View>
          </Animated.View>
